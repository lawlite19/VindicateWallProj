...
// respectively. The change between rows is set to -35 to + 35. The minimum value of any cell is 0.
...
String imageMap1 = c.getHTMLImageMap("", "", "title='[{dataSetName}] {x|mm/yyyy}: {value|0} MByte'")
    ;
%>
<html>
