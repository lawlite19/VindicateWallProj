 ...
 * 
 * @see com.hhit.entity.TbRole
 * @author MyEclipse Persistence Tools
 */
public class TbRoleDAO extends HibernateDaoSupport {
	...
	public static TbRoleDAO getFromApplicationContext(ApplicationContext ctx) {
		return (TbRoleDAO) ctx.getBean("TbRoleDAO");
	}
	...
	public void deleteById(Integer id) {
		...
		try {
			String queryString = "delete from TbRole where Id=?";
